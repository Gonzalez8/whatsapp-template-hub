...
function PanelEmpty() {
  return (
    <div className="flex min-h-[340px] flex-col items-center justify-center px-6 py-16 text-center">
      ...
      <p className="font-display text-[14px] font-bold text-gray-600">Selecciona un template</p>
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="shrink-0 border-b border-gray-100 px-5 py-4">
        <p className="font-display text-[14px] leading-snug font-bold break-words text-gray-900">{template.name}</p>
          ...
          <div className="mt-3.5 flex items-center gap-1">
            <div className="flex rounded-full bg-gray-100/80 p-0.5">
              ...
              <button
                ...
                className={`rounded-full px-3 py-1 text-[11px] font-semibold transition-all duration-200 ${
                  mode === "example" ? "bg-teal-600 text-white shadow-sm" : "text-gray-500 hover:text-gray-700"
                }`}
              >
                Ejemplo
              </button>
