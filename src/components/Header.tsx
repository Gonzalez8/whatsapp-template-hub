export function Header() {
  return (
    <header className="relative left-1/2 -ml-[50vw] mb-6 w-screen overflow-hidden bg-gradient-to-br from-[#052e2a] via-[#075d50] to-[#0d8a6a] px-4 py-6 text-white shadow-[0_4px_24px_-4px_rgba(0,0,0,0.2)] sm:mb-10 sm:px-8 sm:py-10">
      ...
      <div className="relative mx-auto flex max-w-[1400px] items-center gap-3 sm:gap-5">
        {/* WhatsApp icon */}
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white/12 shadow-lg shadow-black/10 ring-1 ring-white/10 backdrop-blur-sm sm:h-13 sm:w-13 sm:rounded-2xl">
        ...
        <div className="min-w-0">
          <h1 className="font-display text-xl font-extrabold tracking-tight sm:text-[26px]">
            Template Hub
          </h1>
