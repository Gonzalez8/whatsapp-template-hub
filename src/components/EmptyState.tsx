  ...
  return (
    <div className="py-28 text-center">
      <div className="relative mx-auto mb-6 flex h-20 w-20 items-center justify-center">
        ...
        <svg className="relative h-9 w-9 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            strokeLinecap="round"
      ...
      <p className="font-display text-lg font-bold text-gray-800">No se encontraron templates</p>
